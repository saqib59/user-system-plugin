...
<div class="modal fade" id="sendall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	 ...
	 <form id="send-files-all" method="post" enctype="multipart/form-data"> 
	      <div class="modal-body">
	        
	          <div class="form-group">
	            <label for="message-text" class="col-form-label">Choose Files (Not more than 10) :</label>
	              <input type="file" id="admin-system-allfiles" name="admin-system-allfiles[]" multiple="multiple">
	            <div><small id="admin-system-allfiles-err" style="color: red;"></small></div>
	          </div>
	      ...
	      <input type="hidden" name="action" value="send_files_all" />
     </form>
