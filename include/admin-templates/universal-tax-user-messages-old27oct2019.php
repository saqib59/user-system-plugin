	...
	<div class="messaging">
	          ...
	          <div class="inbox_chat">
	            ...
	            <div class="chat_list active_chat">
	              ...
	              <div class="chat_people">
					...
					$query = "SELECT * FROM ".$table." WHERE sender_id =".$universal_user->ID." OR sender_id = 1001 AND receiver_id=1001 OR receiver_id =".$universal_user->ID;


					$total_query = "SELECT COUNT(*) FROM ".$table." WHERE sender_id =".$universal_user->ID." OR sender_id = 1001 AND receiver_id=1001 OR receiver_id =".$universal_user->ID;
					...
					$page = isset( $_GET['universal-msg'] ) ? abs( (int) $_GET['universal-msg'] ) : 1;
					...
					if(count($result_sidebar) > 0)


					{


						$result_sidebar_status  = true;


          				if($result_sidebar[0]->sender_id == $universal_user->ID )
	                ...
	                <p style="color: <?php echo (isset($user_msg) && $user_msg == true) ? 'black' : 'green'; ?>">


	                <?php echo (isset($result_sidebar_status) && $result_sidebar_status == true) ? $result_sidebar[0]->message  : ''; ?>  	
      ...
      //   	 			echo "<pre>";
					...
					foreach( array_reverse($result) as $message ) {
						...
						if( $message->sender_id == $universal_user->ID ){ ?>
						...
						<div class="outgoing_msg">
							...
							<!-- <div> <img src="<?php echo get_stylesheet_directory_uri().'/images/';?>admin_pic.jpg"  alt="admin"> </div> -->
	      ...
	      <?php if($totalPage > 1) {
					...
					'base' => add_query_arg( 'universal-msg', '%#%' ),
